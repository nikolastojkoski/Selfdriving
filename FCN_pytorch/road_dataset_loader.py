...
num_class = 2
means     = np.array([118.6786, 118.1411, 116.2199]) / 255. # mean of three channels in the order of BGR
h, w      = 640, 960
train_h   = h
train_w   = w
val_h     = h
...
class RoadDataset(Dataset):
    ...
    def __init__(self, csv_file, phase, n_class=num_class, crop=False, flip_rate=0.5):
