...
class PolygonDrawer(object):
    def __init__(self, window_name, canvas_size=(640,960)):
    ...
    def run(self, image_for_labeling):
...
if __name__ == "__main__":
    ...
    img = cv2.imread('dataset_08_11/sochi12_src_labels/lane_change/road_src_116.png')
    image = pd.run(img)
    cv2.imshow('result_label', image)
    cv2.waitKey()
